...
/**
 * Assertion class.
 * This is a wrapper around the Assert library to throw our own exceptions.
 *
 * @mixin Assertion
 */
class Assert
{
    public const INVALID_FLOAT = 9;
    public const INVALID_INTEGER = 10;
    public const INVALID_DIGIT = 11;
    ...
    {
        try {
            return Assertion::$name(...$arguments);
