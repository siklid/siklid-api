...
interface AuthorizationCheckerInterface
{
     ...
     * @param AuthorizableInterface|null $subject   the subject to secure, The object the user wants to access
     */
     ...
     */
    public function denyAccessUnlessGranted(array|string $attribute, ?AuthorizableInterface $subject = null): void;
}
